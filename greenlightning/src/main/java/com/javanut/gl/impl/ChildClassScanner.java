...
public class ChildClassScanner {
	...
	private static TrieParser buildBlockingTypes() {
		...
		map.setUTF8Value("com.javanut.pronghorn.stage.",1);
		map.setUTF8Value("[Lcom.javanut.pronghorn.stage.",1);
				
		map.setUTF8Value("com.javanut.iot.hardware.",1);
		map.setUTF8Value("[Lcom.javanut.iot.hardware.",1);
												
		map.setUTF8Value("com.javanut.pronghorn.pipe.",1); 
		map.setUTF8Value("[Lcom.javanut.pronghorn.pipe.",1);
				
		map.setUTF8Value("com.javanut.pronghorn.util.",1); 
		map.setUTF8Value("[Lcom.javanut.pronghorn.util.",1);
				
		map.setUTF8Value("com.javanut.pronghorn.network.",1);  
		map.setUTF8Value("[Lcom.javanut.pronghorn.network.",1);
													
		map.setUTF8Value("com.javanut.gl.impl.",1); 
		map.setUTF8Value("[Lcom.javanut.gl.impl.",1);
		
		map.setUTF8Value("com.javanut.gl.test.",1); 
		map.setUTF8Value("[Lcom.javanut.gl.test.",1);
		
		map.setUTF8Value("com.javanut.json.encode.JSONRenderer",1);		
